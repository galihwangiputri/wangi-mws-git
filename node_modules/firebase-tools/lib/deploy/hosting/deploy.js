...
var listFiles = require("../../listFiles").listFiles;
...
module.exports = function (context, options) {
    ...
    function _runDeploys(deploys, debugging) {
        var deploy = deploys.shift();
        utils.logLabeledBullet("hosting[" + deploy.site + "]", "beginning deploy...");
        var t0 = Date.now();
        var publicDir = options.config.path(deploy.config.public);
        var files = listFiles(publicDir, deploy.config.ignore);
    ...
    var deploys = [].concat(context.hosting.deploys);
